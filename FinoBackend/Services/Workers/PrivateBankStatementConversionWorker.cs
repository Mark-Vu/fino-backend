...
public class PrivateBankStatementConversionWorker
{
    private readonly IAmazonTextract _textract;
    private readonly IConfiguration _config;
    private readonly ILogger<PrivateBankStatementConversionWorker> _logger;

    public PrivateBankStatementConversionWorker(
        IAmazonTextract textract,
        IConfiguration config,
        ILogger<PrivateBankStatementConversionWorker> logger)
    {
        _textract = textract;
        _config = config;
        _logger = logger;
